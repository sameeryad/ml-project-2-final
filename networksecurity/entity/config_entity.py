...
class ModelEvaluationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_eval_dir: str = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.MODEL_EVALUATION_DIR_NAME)
        self.model_eval_report_file_path: str = os.path.join(self.model_eval_dir, training_pipeline.MODEL_EVALUATION_REPORT_NAME)
        self.model_eval_best_model_path: str = os.path.join(self.model_eval_dir, training_pipeline.MODEL_EVALUATION_BEST_MODEL_PATH)
...
class ModelPusherConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_pusher_save_dir: str = os.path.join(self.model_pusher_dir, training_pipeline.MODEL_PUSHER_SAVE_DIR)
